...
enum PlayingCardRank: Int {
    ...
    static var allRanks: [PlayingCardRank] {
...
struct Deck {
    ...
    init() {
        var cards = [Card]()
        for rank in PlayingCardRank.allRanks {
...
extension PlayingCardRank: Comparable {
...
class HighLow: CardGame {
    ...
    func play() {
        ...
        if card1 > card2 {
            print("Player 1 wins with a \(card1.rank) of \(card1.suit)!")
        } else if card2 > card1 {
            print("Player 2 wins with a \(card2.rank) of \(card2.suit)!")
        } else {
            print("The round ends in a tie with a \(card1.rank) of \(card1.suit) and a \(card2.rank) of \(card2.suit).")
        }
    }
}
