...
// create a varialble OUTSIDE of the while loop: var count = 0, then inside of the loop, you increment that count. Need a condition Saying something like
// if count <= numberOfItems {
//execute code here } else {
//break out of the loop. Then at the end at the condition, increment the count.
