...
enum SuitPlayingCards: String {
    case hearts
    case diamonds
    case spades
    case clubs
    
    static var allSuits: [SuitPlayingCards] {
...
struct Deck {
    ...
    init() {
        ...
        for rank in Rank.allRanks {
            for suit in SuitPlayingCards.allSuits {
...
class HighLow: CardGame {
    ...
    func play() {
        ...
        if playerOne > playerTwo {
            ...
            print("Round ends in a tie with \(playerOne.description) and \(playerTwo.description)")
        }
