...
extension Deck {
    func drawCard() -> Card {
        // I think I can force unwrap this here because you can only operate this function if you create a deck and the initialization of the deck fills the array
...
class HighLow: CardGame {
    ...
    func play() {
        ...
        if player1Draw > player2Draw {
            ...
            print("The game ends in a draw with a \(player1Draw) and a \(player2Draw)")
        }
    }
...
class CardGameTracker: CardGameDelegate {
    func gameDidStart(game: CardGame) {
        print("Started a new game of \(game.self).")
    }
...
let myGame = HighLow(deck: Deck(), delegate: CardGameTracker())
