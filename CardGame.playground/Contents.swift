    ...
    init() {
        ...
        for rank in Rank.allRanks {
            for suit in Suit.allSuits {
                anotherDeckInstance.append(Card(cardRank: rank, cardSuit: suit))
            }
        }
        self.deckInstance = anotherDeckInstance
    }
}
...
extension Rank {
    static var allRanks: [Rank] {
        [self.ace, self.two, self.three, self.four, self.five, self.six, self.seven, self.eight, self.nine, self.ten, self.jack, self.queen, self.king]
    }
}
//: ## Step 8
...
extension HighLow {
    func play() {
        ...
        if playerOneCard == playerTwoCard {
            print("Round ends in a tie with \(playerTwoCard.cardRank) of \(playerTwoCard.cardSuit)")
        } else if playerOneCard < playerTwoCard {
            print("Player 2 wins with \(playerTwoCard.cardRank) of \(playerTwoCard.cardSuit)")
