...
// already did this in the last 3 steps... 
...
// I SAID I ALREADY DID THIS IN THE LAST STEPS!!!
...
// This will be completed below in step 19
...
extension HighLow {
    func play() {
        ...
        if player1Card == player2Card {
            print("Round end in a tie with \(player1Card)")
        }
