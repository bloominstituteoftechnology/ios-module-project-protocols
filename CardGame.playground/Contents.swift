...
enum Rank: Int {
    ...
    static var allRanks: [Rank] {
        ...
        return [.ace, .two, .three, .four, .five, .six, .seven, .eight, .nine, .jack, .queen, .king]
    }
...
class HighLow:CardGame {
    ...
    func play() {
        ...
        if player1Card > player2Card {
            ...
            print("Round end in a tie with \(player1Card.description).")
        }
    }
...
extension Card: Comparable {
    ...
    static func == (lhs: Card, rhs: Card) -> Bool {
        lhs.cardRank.rawValue == rhs.cardRank.rawValue && lhs.cardSuit.rawValue == rhs.cardSuit.rawValue
    }
}
