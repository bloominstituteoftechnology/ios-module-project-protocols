...
var myCard = Card(rank: .ace, suit: .clubs)
...
struct Deck {
    ...
    func drawCard() -> Card {
        return deckOfCards[Int.random(in: 0...deckOfCards.count - 1)]
    }
...
//:}
//:```
//Already iterated through and set up my deck on step 6
//Using a different method. Enums use a CaseIterable protocol which returns an array when calling "Name".allCases
